...
| 58 | TERNARY = GROVER = LIPID = LOUISE = MAX = DIRAC | §171, §173, taxicab | MAX=DIRAC=LOUISE=TERNARY |
...
| 65 | ALEXA = 5×13 | §177 | |
| 66 | SEVEN = VECTOR = NETWORK = MEASURE = ALBERT = THEOREM | §167, §169, §173, §174, taxicab | ALBERT=THEOREM; Einstein's first name IS theorem |
...
| 79 | MARCH = INTEGRATE = CREATIVE = HELIUM = GOVERN = JORDAN = PRIME POWER = HILBERT | §169, §177, taxicab | prime; HILBERT=JORDAN=MARCH |
...
| 101 | MAXWELL = DERIVATIVE = GAUSSIAN = KINETICS = NUMBERS = SINGULAR = TERMINAL | §160, §173, §175, §178, taxicab | prime; MAXWELL=GAUSSIAN |
